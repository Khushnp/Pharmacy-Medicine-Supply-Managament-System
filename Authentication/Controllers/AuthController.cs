...
namespace AuthenticationService.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        private string GenerateJWT(string userName, string role, string key)
        {
            ...
            var token = new JwtSecurityToken(issuer: "https://www.PMSMS_MvcApp.com", audience: "https://www.PMSMS_MvcApp.com", expires: DateTime.Now.AddMinutes(30), signingCredentials: credentials, claims: claims);
